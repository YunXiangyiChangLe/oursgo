...
// Generated from d:\Study\XMZ\h3\grammar\GoParser.g4 by ANTLR 4.9.2
...
GoParser::ExpressionContext* GoParser::expression(int precedence) {
  ...
  try {
    ...
    case 2: {
      ...
      previousContext = _localctx;
      setState(746);
      dynamic_cast<UnaryOperationContext *>(_localctx)->unary_op = _input->LT(1);
      _la = _input->LA(1);
      if (!(((((_la - 60) & ~ 0x3fULL) == 0) &&
        ...
        dynamic_cast<UnaryOperationContext *>(_localctx)->unary_op = _errHandler->recoverInline(this);
      }
      else {
        _errHandler->reportMatch(this);
        consume();
    ...
    while (alt != 2 && alt != atn::ATN::INVALID_ALT_NUMBER) {
      if (alt == 1) {
        ...
        case 1: {
          ...
          setState(751);
          dynamic_cast<MulDivOperationContext *>(_localctx)->mul_op = _input->LT(1);
          _la = _input->LA(1);
          if (!(((((_la - 55) & ~ 0x3fULL) == 0) &&
            ...
            dynamic_cast<MulDivOperationContext *>(_localctx)->mul_op = _errHandler->recoverInline(this);
          }
          else {
            _errHandler->reportMatch(this);
            consume();
        ...
        case 2: {
          ...
          setState(754);
          dynamic_cast<PlusMinusOperationContext *>(_localctx)->add_op = _input->LT(1);
          _la = _input->LA(1);
          if (!((((_la & ~ 0x3fULL) == 0) &&
            ...
            dynamic_cast<PlusMinusOperationContext *>(_localctx)->add_op = _errHandler->recoverInline(this);
          }
          else {
            _errHandler->reportMatch(this);
            consume();
        ...
        case 3: {
          ...
          setState(757);
          dynamic_cast<RelationOperationContext *>(_localctx)->rel_op = _input->LT(1);
          _la = _input->LA(1);
          if (!((((_la & ~ 0x3fULL) == 0) &&
            ...
            dynamic_cast<RelationOperationContext *>(_localctx)->rel_op = _errHandler->recoverInline(this);
          }
          else {
            _errHandler->reportMatch(this);
            consume();
...
bool GoParser::sempred(RuleContext *context, size_t ruleIndex, size_t predicateIndex) {
  switch (ruleIndex) {
    ...
    case 71: return primaryExprSempred(dynamic_cast<PrimaryExprContext *>(context), predicateIndex);
