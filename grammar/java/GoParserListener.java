...
public interface GoParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by the {@code LogicalAndOperation}
	 * labeled alternative in {@link GoParser#expression}.
	 * @param ctx the parse tree
	 */
	void enterLogicalAndOperation(GoParser.LogicalAndOperationContext ctx);
	/**
	 * Exit a parse tree produced by the {@code LogicalAndOperation}
	 * labeled alternative in {@link GoParser#expression}.
	 * @param ctx the parse tree
	 */
	...
	/**
	 * Enter a parse tree produced by the {@code PlusMinusOperation}
	 * labeled alternative in {@link GoParser#expression}.
	 * @param ctx the parse tree
	 */
	void enterPlusMinusOperation(GoParser.PlusMinusOperationContext ctx);
	/**
	 * Exit a parse tree produced by the {@code PlusMinusOperation}
	 * labeled alternative in {@link GoParser#expression}.
	 * @param ctx the parse tree
	 */
	void exitPlusMinusOperation(GoParser.PlusMinusOperationContext ctx);
	/**
	 * Enter a parse tree produced by the {@code RelationOperation}
	 * labeled alternative in {@link GoParser#expression}.
	 * @param ctx the parse tree
	 */
	void enterRelationOperation(GoParser.RelationOperationContext ctx);
	/**
	 * Exit a parse tree produced by the {@code RelationOperation}
	 * labeled alternative in {@link GoParser#expression}.
	 * @param ctx the parse tree
	 */
	void exitRelationOperation(GoParser.RelationOperationContext ctx);
	/**
	 * Enter a parse tree produced by the {@code MulDivOperation}
	 * labeled alternative in {@link GoParser#expression}.
	 * @param ctx the parse tree
	 */
	void enterMulDivOperation(GoParser.MulDivOperationContext ctx);
	/**
	 * Exit a parse tree produced by the {@code MulDivOperation}
	 * labeled alternative in {@link GoParser#expression}.
	 * @param ctx the parse tree
	 */
	...
	/**
	 * Enter a parse tree produced by {@link GoParser#eoss}.
	 * @param ctx the parse tree
	 */
	void enterEoss(GoParser.EossContext ctx);
	/**
	 * Exit a parse tree produced by {@link GoParser#eoss}.
	 * @param ctx the parse tree
	 */
